...
```sh
  cd my-folder
  git clone  https://github.com/Balikuddembe/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Balikuddembe/hello-rails-react/issues).
